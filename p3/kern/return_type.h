...
/* syscall.c */
#define ERROR_FORK_MALLOC_TASK_FAILED -1
#define ERROR_FORK_COPY_FIR_FAILED -2
#define ERROR_FORK_MALLOC_THREAD_FAILED -3
#define ERROR_FORK_MALLOC_KERNEL_STACK_FAILED -3
