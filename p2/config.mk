...
# directory
#
410TESTS = getpid_test1 cat halt_test startle misbehave_wrap thr_exit_join join_specific_test multitest agility_drill cyclone largetest mandelbrot racer cvar_test stack_test1 switzerland rwlock_downgrade_read_test paraguay
...
# directory
#
STUDENTTESTS = allocator_test a

###########################################################################
# Object files for your thread library
###########################################################################
THREAD_OBJS = malloc.o panic.o thread.o start_thread.o wrap_thread_proc.o thread_table.o allocator.o mutex_asm.o list.o mutex.o cond.o sem.o rwlock.o
